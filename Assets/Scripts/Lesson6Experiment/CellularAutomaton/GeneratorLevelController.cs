...
namespace NikolayT2DGame
{
    public class GeneratorLevelController
    {
        ...
        private bool _marchingSquareIsOn;
        private bool _borderIsOn;
        ...
        public GeneratorLevelController(GenerateLevelView generateLevelView, 
            bool marchingSqareIsOn = false, bool borderIsOn = true)
        {
            ...
            _marchingSquareIsOn = marchingSqareIsOn;
            _borderIsOn = borderIsOn;
        }
        ...
        private void RandomFillLevel()
        {
            ...
            for (var x = 0; x < _widthMap; x++)
            {
                ...
                {
                    if ((x == 0 || x == _widthMap - 1 || y == 0 || y == _heightMap - 1) && _borderIsOn)
                        _map[x, y] = 1;
                    else
